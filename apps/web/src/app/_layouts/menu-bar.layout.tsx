...
export default function MenuBarLayout({ hasAppBar, menuBar, className, ...props }: MenuBarLayoutProps) {
  return (
    <div className={cn('flex-1 items-start md:grid md:grid-cols-[232px_minmax(0,1fr)]', className)}>
      <aside
        className={cn(
