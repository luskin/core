...
export default function Page() {
  const [singleSliderValue, setSingleSliderValue] = useState<Array<number>>([
    50,
  ])
  const [doubleSliderValue, setDoubleSliderValue] = useState<Array<number>>([
    25, 75,
  ])
  const [tripleSliderValue, setTripleValueSlider] = useState<Array<number>>([
    25, 50, 75,
  ])
  return (
    <>
      ...
      <Column gap={4} className={"mt-4"}>
        <Label className="mt-2 mb-2">
          The current value of the single slider is: {singleSliderValue[0]}
        </Label>
        <Slider
          min={0}
          max={100}
        ...
        />
        <Label className="mt-2 mb-2">
          The current value of the double slider is: {doubleSliderValue[0]} -{" "}
          {doubleSliderValue[1]}
        </Label>
        <Slider
          min={0}
          ...
          onValueChange={setDoubleSliderValue}
        />
        <Label className="mt-2 mb-2">
          The current value of the triple slider is: {tripleSliderValue[0]} -{" "}
          {tripleSliderValue[1]} - {tripleSliderValue[2]}
        </Label>
        <Slider
          min={0}
          max={100}
