    ...
    <PageView>
      <Column gap={4}>
        <DesignComponentHeader
          ...
          description={
            <Paragraph>
              There are four variants of alerts: <code>warning</code>, <code>error</code>, <code>info</code>, and{' '}
              <code>success</code>.
            </Paragraph>
          }
        />
        ...
        <Alert icon="alienShip" title="You have been abducted" message="The Mothership has you now." variant={'info'} />
        <ComponentPropsGrid
          params={[
            {
              name: 'icon',
